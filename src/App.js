    ...
    <>
      ...
      <Routes>
        <Route
          path="/lesson/:id"
          element={
            <PrivateRoute isLoading={isLoading} roles={["user", "admin"]}>
              <Lesson />
            </PrivateRoute>
          }
        />
        ...
        <Route
          path="/login"
          element={
            <PrivateRoute isLoading={isLoading} roles={["guest"]}>
              <LoginPage />
            </PrivateRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <PrivateRoute isLoading={isLoading} roles={["user", "admin"]}>
              <Catalog title={"Граматика"} type={"grammar"} />
            </PrivateRoute>
          }
        />
        <Route
          ...
          element={
            <PrivateRoute isLoading={isLoading} roles={["user", "admin"]}>
              <Catalog title={"Словниковий запас"} type={"vocabulary"} />
            </PrivateRoute>
          }
        />
        <Route
          ...
          element={
            <PrivateRoute isLoading={isLoading} roles={["user", "admin"]}>
              <Catalog title={"Типові помилки"} type={"typicalError"} />
            </PrivateRoute>
          }
        />
        <Route
